...
export default function Puzzle6() {
    const puzzleImage = "/images/eiffeltower.webp"; 
    ...
    return (
        <div className={styles.container}>
            <div className={styles.jigsawsidebar}>
                <h1 className={styles.jigsawcenterText}>Planet Jigsaws – Play Space Jigsaw Puzzles Online</h1>
            ...
            <div ref={puzzleContainerRef} className={styles.jigsawpuzzleBoard}>
                {!isStarted && (
                    <div className={styles.jigsawoverlay}>
                        <h2>Welcome to the Puzzlesplan Game!</h2>
